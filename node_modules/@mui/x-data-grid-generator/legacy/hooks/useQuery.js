...
var getFilteredRows = function getFilteredRows(rows, filterModel, columnsWithDefaultColDef) {
  ...
  var valueGetters = filterModel.items.map(function (_ref3) {
    var columnField = _ref3.columnField;
    return simplifiedValueGetter(columnField, columnsWithDefaultColDef.find(function (_ref4) {
      var field = _ref4.field;
      return field === columnField;
    }));
  });
  var filterFunctions = filterModel.items.map(function (filterItem) {
    var columnField = filterItem.columnField,
        operatorValue = filterItem.operatorValue;
    var colDef = columnsWithDefaultColDef.find(function (_ref5) {
      var field = _ref5.field;
      return field === columnField;
    });
    var filterOperator = colDef.filterOperators.find(function (_ref6) {
...
export var loadServerRows = function loadServerRows(rows, queryOptions, serverOptions, columnsWithDefaultColDef) {
  ...
  if (!pageSize) {
    ...
    firstRowIndex = cursor ? filteredRows.findIndex(function (_ref7) {
      var id = _ref7.id;
      return id === cursor;
    }) : 0;
